...
/**
 * Extend the ArrayList class by implementing the getEveryNthElement() method. This method returns a list of
 * elements and takes two parameters:
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(customArrayList.getEveryNthElement(-2,1));
    }
}

 ...
 * Based on these points, the Circle class is to determine: • circle radius when calling double getRadius() method • circle circumference
 * when calling double getPerimeter() method • circle area when calling double getArea() method
 *
...
public class Main {
    public static void main(String[] args) {
        ...
        MovableDirection movableDirection= new MovableDirection(2,2);
